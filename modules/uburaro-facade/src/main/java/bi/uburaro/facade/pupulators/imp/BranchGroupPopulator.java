...
public class BranchGroupPopulator implements Populator<BranchGroupType, BranchGroupData> {
    private final Converter<HotelType, HotelData> hotelConverter;

    public BranchGroupPopulator(Converter<HotelType, HotelData> hotelConverter) {
