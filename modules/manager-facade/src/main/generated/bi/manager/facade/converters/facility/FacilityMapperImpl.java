...
public class FacilityMapperImpl implements FacilityMapper {
    ...
    public MBFacilityData facilityToData(MBFacilityType facility) {
        ...
        mBFacilityData.setCapital( capitalToData( facility.getCapital() ) );
    ...
    public MBFacilityType facilityToType(MBFacilityData facility) {
        ...
        mBFacilityType.setCapital( mBCapitalDataToMBCapitalType( facility.getCapital() ) );
    ...
    protected MBCategoryType mBCategoryDataToMBCategoryType(MBCategoryData mBCategoryData) {
        ...
        mBCategoryType.setFacility( facilityToType( mBCategoryData.getFacility() ) );
    ...
    protected MBClientType mBClientDataToMBClientType(MBClientData mBClientData) {
        ...
        mBClientType.setFacility( facilityToType( mBClientData.getFacility() ) );
