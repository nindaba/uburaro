...
@Mapper(componentModel = "spring",uses = {ClientMapper.class, RentContractMapper.class})
public interface RentPropertyMapper {
    ...
    @Mapping(target = MBRentPropertyType.CONTRACTS, ignore = true)
